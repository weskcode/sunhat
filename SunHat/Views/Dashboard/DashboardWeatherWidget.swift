//
//  DashboardWeatherWidget.swift
//  SunHat
//
//  DashboardView's self-contained hero weather card: current temperature,
//  condition, high/low/wind pills, and the unavailable-weather fallback.
//
...
extension DashboardView {
    ...
    @ViewBuilder
    var currentTemperatureWidget: some View {
