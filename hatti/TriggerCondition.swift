...
final class TriggerCondition {
    ...
    var triggerType: TriggerType = .exactTemperature
    ...
    var comparisonType: ComparisonType = .above
    ...
    var precipitationRequirement: PrecipitationRequirement = .none
    ...
    // Relationship
    @Relationship(deleteRule: .nullify, inverse: \WeatherReminder.triggerCondition)
