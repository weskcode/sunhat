# Hatti App iOS 26 Migration Guide

## Overview

This guide documents the comprehensive upgrade of the Hatti weather-based reminder app from iOS 18.5 to iOS 26, including all API updates, architectural improvements, and new features.
...
#### Unit Tests
- **File:** `hattiTests/hattiTests.swift`
- **Changes:**
...
#### UI Tests
- **File:** `hattiUITests/hattiUITests.swift`
- **Changes:**
