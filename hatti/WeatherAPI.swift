...
actor AppleWeatherKitAPI: WeatherAPI {
    ...
    private func mapWeatherKitCondition(_ condition: WeatherCondition) -> hatti.WeatherCondition {
        switch condition {
        ...
        case .breezy, .windy: return .clear // No direct mapping
